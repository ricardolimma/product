...
- [Gerando DTOs e Controllers](#gerando-dtos-e-controllers)
...
**cURL**
```bash
curl "http://localhost:8080/product/v1/products/MLB-526805033"
```
...
- Parâmetros: `page` (base 0), `size` (1..100).
- Metadados na resposta: `page`, `size`, `totalItems`, `totalPages`, `hasNext`, `hasPrevious`.
- Implementação usa `Pageable`/`PageImpl` para replicar comportamento de paginação mesmo com dados em memória.
